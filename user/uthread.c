...
/* Possible states of a uthread: */
enum threadstate { FREE, RUNNING, RUNNABLE };
...
struct thread {
  ...
  enum threadstate state; /* FREE, RUNNING, RUNNABLE */
...
void thread_init(void) {
  ...
  printf("t1:%p,t2%p,t3:%p,t4:%p\n", &all_thread[0], &all_thread[1],
         &all_thread[2], &all_thread[3]);
}
